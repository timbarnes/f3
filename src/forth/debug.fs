...
\ dump-stringspace - dumps buffers and strings
\ dump-strings ( s_addr -- ) - dumps multiple strings from s_addr (must be a count byte)
\ dump-string  ( s_addr -- ) - dumps a single string at s_addr
